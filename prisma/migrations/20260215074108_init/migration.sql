...
-- AddForeignKey
ALTER TABLE "expense_splits" ADD CONSTRAINT "expense_splits_participant_id_fkey" FOREIGN KEY ("participant_id") REFERENCES "group_members"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
